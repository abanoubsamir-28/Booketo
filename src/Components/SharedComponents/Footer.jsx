                ...
                <div className="container">
                    <div className="row justify-content-center align-items-center py-2">
                        <div className="col-md-12 text-center py-2 ">
                            <h2 ><a className=" text-light text-decoration-none" href="google.com/">Booketo.com</a></h2>
                            <p className="menu">
                                <Link className="mx-1 text-light text-decoration-none" to="/">Home</Link>
                                <Link className="mx-1 text-light text-decoration-none" to="/contactForm">Contact</Link>
                                <Link className="mx-1 text-light text-decoration-none" to="/getbooks">Books</Link>
                                <Link className="mx-1 text-light text-decoration-none" to="/register">Resister</Link>
