            ...
            <div className="row justify-content-center">
                <div className="col-xl-2 col-md-3 col-sm-6 py-4" >
                    <Card className="h-100 book__card__bookSearch">
                        <Card.Img variant="top" className="h-50" src="https://upload.wikimedia.org/wikipedia/commons/4/47/LOGO_%D8%AF%D8%A7%D8%B1_%D8%A7%D9%84%D8%B3%D9%84%D8%A7%D9%85.jpg" alt="" />
                        <Card.Body className="book__card__bookSearch">
                            <Card.Title className="text-center">دار السلام</Card.Title>
                            <Card.Text>
                                <Link to="" className="btn btn btn-primary mt-2">Visit Book Store</Link>
                            </Card.Text>
                        </Card.Body>
                    </Card>
                </div>
                ...
                <div className="col-xl-2 col-md-3 col-sm-6 py-4" >
                    <Card className="h-100 book__card__bookSearch">
                        <Card.Img variant="top" className="h-50" src="https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Ftse4.mm.bing.net%2Fth%3Fid%3DOIP.erj-t3kmkGraq1TrxSCTdwAAAA%26pid%3DApi&f=1" alt="" />
                        <Card.Body className="book__card__bookSearch">
                ...
                <div className="col-xl-2 col-md-3 col-sm-6 py-4" >
                    <Card className="h-100 book__card__bookSearch">
                        <Card.Img variant="top" className="h-50" src="https://dardawen.com/wp-content/uploads/2021/06/DarDawen_201908_390729.png" alt="" />
                        <Card.Body className="book__card__bookSearch">
                ...
                <div className="col-xl-2 col-md-3 col-sm-6 py-4" >
                    <Card className="h-100 book__card__bookSearch">
                        <Card.Img variant="top" className="h-50" src="https://www.hindawi.org/content/images/logo.svg" alt="" />
                        <Card.Body className="book__card__bookSearch">
                ...
                <div className="col-xl-2 col-md-3 col-sm-6 py-4" >
                    <Card className="h-100 book__card__bookSearch">
                        <Card.Img variant="top" className="h-50" src="https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fnewtechclub.com%2Fwp-content%2Fuploads%2F2017%2F09%2Fbooksdrd-logo.png&f=1&nofb=1" alt="" />
                        <Card.Body className="book__card__bookSearch">
                ...
                <div className="col-xl-2 col-md-3 col-sm-6 py-4" >
                    <Card className="h-100 book__card__bookSearch">
                        <Card.Img variant="top" className="h-50" src="https://upload.wikimedia.org/wikipedia/ar/4/4e/Kotopia_logo.jpg" alt="" />
                        <Card.Body className="book__card__bookSearch">
